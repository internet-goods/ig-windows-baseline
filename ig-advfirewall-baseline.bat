...
netsh advfirewall firewall set rule name="Core Networking - IPv6 (IPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Done (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Query (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Report (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Report v2 (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Neighbor Discovery Advertisement (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Neighbor Discovery Solicitation (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Packet Too Big (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Parameter Problem (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Parameter Problem (ICMPv6-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Core Networking - Router Advertisement (ICMPv6-In)" dir=in new enable=No
...
netsh advfirewall firewall set rule name="Network Discovery (NB-Name-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Network Discovery (Pub-WSD-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Network Discovery (SSDP-In)" dir=in new enable=No
netsh advfirewall firewall set rule name="Network Discovery (UPnP-In)" dir=in new enable=No
...
netsh advfirewall firewall set rule name="Remote Assistance (SSDP TCP-In)" dir=in new enable=No
...
netsh advfirewall firewall set rule name="Core Networking - Internet Group Management Protocol (IGMP-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - IPHTTPS (TCP-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - IPv6 (IPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Done (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Query (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Report (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Multicast Listener Report v2 (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Neighbor Discovery Advertisement (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Neighbor Discovery Solicitation (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Packet Too Big (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Parameter Problem (ICMPv6-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Core Networking - Router Advertisement (ICMPv6-Out)" dir=out new enable=No
...
netsh advfirewall firewall set rule name="Network Discovery (SSDP-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Network Discovery (UPnPHost-Out)" dir=out new enable=No
netsh advfirewall firewall set rule name="Network Discovery (UPnP-Out)" dir=out new enable=No
