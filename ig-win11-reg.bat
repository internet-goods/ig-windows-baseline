#REM https://github.com/SigmaHQ/sigma/tree/master/rules/windows/registry/r
...
#REMhttps://github.com/SigmaHQ/sigma/blob/master/rules/windows/registry/registry_set/registry_set_enabling_turnoffcheck.yml
reg add HKLM\Policies\Microsoft\Windows\ScriptedDiagnostics /v TurnOffCheck /t REG_DWORD /d 0

#32b runkey
#REMhttps://github.com/SigmaHQ/sigma/blob/0597250ee1008d2354e457cb9eff3a8490457cd2/rules/windows/registry/registry_set/registry_set_asep_reg_keys_modification_currentversion.yml#L29
